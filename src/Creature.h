...
public:
	//Konstruktor
	Creature();
	Creature(float x, float y, int w, int h, int hea, int str, float spe, float jSpe, float fSpe, int jumpH);
	//FrameVariabeln
	int walkFrame;
	int idleFrame;
	int jumpFrame;
	...
	bool colUp;
	bool colDown;
	bool checkCollision(Creature obj);
